...
def compute_box_3d(obj, P):
    ...
    obj is in camera coord, [camera coord] -> [rect camera coord] -> [left image coord]
    Returns:
...
def get_lidar_index_in_image_fov(pc_velo, calib, xmin, ymin, xmax, ymax, clip_distance=2.0):
    """ Filter lidar points, keep those in image FOV """
    pts_2d = calib.project_velo_to_image(pc_velo)
    fov_inds = (
        (pts_2d[:, 0] < xmax)
